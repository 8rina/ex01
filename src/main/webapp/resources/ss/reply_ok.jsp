...
<%
	...
	String sql = "SELECT REF, INDENT, STEP FROM gongji2 WHERE id=" + idx;
	...
	sql = "UPDATE gongji2 SET STEP=STEP+1 where REF="+ref+" and STEP>" +step; 

	stmt.executeUpdate(sql);
	
	sql = "INSERT INTO gongji2(USER,TITLE,content,DATE,REF,INDENT,STEP) "+
			"values(?,?,?,now(),?,?,?)";
