...
<%
	...
	String sqlCount = "SELECT COUNT(*) FROM gongji3";
	...
	String sqlSort = "SELECT id from gongji3 order by ref desc, step asc";
	rs = stmt.executeQuery(sqlSort);

	while(rs.next())
	{
		int stepNum = rs.getInt(1);
		sql = "UPDATE gongji3 SET STEP2=" + sort + " where id=" +stepNum;
	...
	String seeall = "select id, user, title, date,view,indent from gongji3 where STEP2 >="+start + " and STEP2 <= "+ endpg +" order by step2 asc";
